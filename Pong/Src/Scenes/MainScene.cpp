...
public:
    ...
    void Init() override 
    {
        ...
        entityManager->CreateEntity(player1, new Vector2(0, 0), renderer, input);
        entityManager->CreateEntity(player2, new Vector2(0, 0), renderer, input);
        entityManager->CreateEntity(ball, new Vector2(0, 0), renderer, input);
    ...
    void Update() override
    {
        ...
        // Collision
        if (Physics::IsColliding(player1, ball)) ball->dir = new Vector2(ball->dir->_x * -1, rand() % 2);
        if (Physics::IsColliding(player2, ball)) ball->dir = new Vector2(ball->dir->_x * -1, rand() % 2);
    }
